...
<img width="1800" height="900" alt="Image" src="https://github.com/user-attachments/assets/9e27561f-ea04-42fd-a746-d20392e6bec8" />
...
<img width="1800" height="900" alt="Image" src="https://github.com/user-attachments/assets/ea950878-c2db-4b49-9357-50833a366979" />

## 手动全局生成（修改 config.json 或按需要）
- 仓库页面导航：`Actions` -> `build Gmeek` -> `Run workflow`

<img width="1800" height="1200" alt="Image" src="https://github.com/user-attachments/assets/dd931567-626c-4bb9-a492-be25b7131e97" />
